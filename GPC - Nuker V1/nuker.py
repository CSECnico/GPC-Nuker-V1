...
░╚═════╝░╚═╝░░░░░░╚════╝░
    ...
    print(f'''{Fore.MAGENTA} 
    Made By Nicø#6666
    Github : https://github.com/NicoChineli
    Prefix : $ , $nuke
    ''')
    await client.change_presence(
    status=discord.Status.do_not_disturb,
    activity=discord.Game(name='https://github.com/NicoChineli'))
...
client.run('MTA0MTY4ODgzMzMyODE1NjcwMg.GHEjto.5d-yjLLTKByVwBOSt9-06INsulOiTAic3Z9AfE') #Input Your Own Token Here
